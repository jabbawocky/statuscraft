...
const server = new Server({ name: "statuscraft", version: "2.45.0" }, { capabilities: { tools: {} } });
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        ...
        {
            name: "list_services",
            description: "List all 1383 services tracked by StatusCraft, with their IDs and tags. Use this to discover service IDs for get_status.",
            inputSchema: {
                type: "object",
                properties: {
                    filter_tag: {
